...
public class LobbyController extends Client implements Initializable{

    @FXML ScrollPane GameRoomContainer;
    @FXML ScrollPane PlayerListContainer;
    @FXML AnchorPane GameRoomCreateWindow;
    @FXML AnchorPane connectFileWindows;
    @FXML AnchorPane nicSetWindow;
    @FXML TextField tfGameRoomCreateName;
    @FXML TextField tfUserInputNickName;
    @FXML AnchorPane serverConnectTryWindow;
    private boolean enableNickname = false;
    @FXML Label lbMessage;
    @FXML Text tUserNickname;
