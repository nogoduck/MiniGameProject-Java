...
//        Parent root = FXMLLoader.load(getClass().getResource("SetNickname.fxml"));
...
//                Node node = (Node)(e.getSource());
//        Stage stage = (Stage)(node.getScene().getWindow());
//        Parent root = FXMLLoader.load(SetNicknameModalController.class.getResource("SetNickname.fxml"));
//        Scene scene = new Scene(root);
//        stage.setTitle("부루마블");
//        stage.setScene(scene);
//        stage.show();
